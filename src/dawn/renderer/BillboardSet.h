...
public:
    ...
    void draw(Renderer* renderer, uint view, LargeSceneNodeR* camera, const Mat4&,
...
private:
    ...
    void update(LargeSceneNodeR* camera_transform);
    void calculateAxes(LargeSceneNodeR* camera_transform, const ParticleData& data, Vec3& axis_x,
                       Vec3& axis_y);
};
}  // namespace dw
